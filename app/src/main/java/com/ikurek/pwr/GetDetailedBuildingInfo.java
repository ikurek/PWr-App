...
public class GetDetailedBuildingInfo {
    ...
    public String[] getBuildingData(String buildingName) {
        ...
        } else if (Objects.equals(buildingName, "A-7 (Zielony Domek)")) {
        ...
        } else if (Objects.equals(buildingName, "A-11")) {
        ...
        } else if (Objects.equals(buildingName, "E-1 (Hogwart)")) {
        ...
        } else if (Objects.equals(buildingName, "H-12")) {

            buildingdata = context.getResources().getStringArray(R.array.H_12);

        } else if (Objects.equals(buildingName, "H-13")) {
        ...
        } else if (Objects.equals(buildingName, "L-1 (Geocentrum)")) {
        ...
        } else if (Objects.equals(buildingName, "M-6")) {
